...
const MBAAdmissions = () => {
  const admissionProcess = [
    ...
    },
    {
      step: 2,
      title: "Entrance Exam",
      description: "Appear for CAT/MAT/CMAT or equivalent entrance examination and submit valid scores.",
    },
    {
      step: 3,
      title: "Group Discussion & Personal Interview",
      description: "Shortlisted candidates will be called for Group Discussion (GD) and Personal Interview (PI).",
    },
    {
      step: 4,
  ...
  const requiredDocuments = [
    "Bachelor's degree certificate (original and photocopy)",
    "Mark sheets of all semesters/years (original and photocopy)",
    "Entrance exam scorecard (CAT/MAT/CMAT)",
  ...
  const eligibilityCriteria = {
    ...
    entrance: "Valid score in CAT/MAT/CMAT or equivalent entrance examination",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-gradient-to-r from-primary to-primary-light text-primary-foreground py-20 px-4">
        <div className="container mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">MBA Admissions</h1>
          <p className="text-xl max-w-3xl mx-auto text-primary-foreground/90">
            Begin your journey to become a business leader. Join our MBA program and transform your career.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 gsap-fade">
        <div className="container mx-auto max-w-4xl">
          <FeeStructure
            title="MBA Fee Structure (Indicative)"
            subtitle="First year fees and recurring charges"
            accent="secondary"
            rows={[
              { item: "Tuition Fee (per year)", amount: "1,50,000" },
              { item: "University/Exam Fees", amount: "10,000" },
              { item: "Library & Digital Resources", amount: "7,500" },
              { item: "Laboratory/Workshop (if applicable)", amount: "5,000" },
              { item: "Development Fee", amount: "12,500" },
